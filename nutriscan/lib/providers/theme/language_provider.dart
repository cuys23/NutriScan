...
// import 'package:shared_preferences/shared_preferences.dart'; // only needed for persisted language switching, disabled below

// Language switching is disabled — English is the app's only language.
// The persistence, picker callback, and per-language font/name lookups below
// are commented out rather than deleted so the feature can be turned back on
// by uncommenting this file plus lib/widgets/common/language_dropdown.dart
// and its call sites in settings_screen.dart / slow_kitchen_home.dart.
class LanguageProvider extends ChangeNotifier {
  final String _currentLanguage = 'en'; // Locked to English
  ...
  // Get current font family name — always English's, since switching is disabled.
